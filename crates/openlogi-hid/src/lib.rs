...
pub use host::{
    apply_litra, channel_pool, dump_features, dump_firmware_entities, dump_monochrome_leds,
    dump_onboard_profiles, dump_reprog_controls, enumerate, enumerate_standalone, get_backlight,
    get_dpi, get_dpi_info, get_report_rate_info, get_scroll_wheel_mode, get_smartshift_status,
    list_pairing_receivers, play_haptic, read_battery_raw, set_backlight_enabled, set_dpi,
    set_fn_lock, set_keyboard_color, set_keyboard_color_with, set_report_interval,
